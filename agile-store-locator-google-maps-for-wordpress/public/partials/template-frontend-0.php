...
$ddl_class_grid = ($all_configs['search_2'])? 'col-xs-4': 'col-xs-4';
$tsw_class_grid = ($all_configs['search_2'])? 'col-xs-4 col-md-2': 'col-xs-4 col-md-2';
$adv_class_grid = ($all_configs['search_2'])? 'col-sm-8': 'col-sm-12';
    ...
    <div class="col-sm-4 col-xs-12 asl-panel">
      ...
      <div class="col-xs-12 inside search_filter">
        ...
        <div class="asl-store-search">
            <input type="text" value="<?php echo $default_addr ?>" id="auto-complete-search" class="<?php echo $search_type_class ?> form-control" placeholder="<?php echo __( 'Enter a postcode or suburb', 'asl_locator') ?>">
  ...
  <div class="item" data-id="{{:id}}">
    ...
    <div class="row">
      <div class="mt-10 distance">
          <div class="col-xs-6">
            <p class="p-direction"><span class="s-direction helloooooooo"><?php echo __( 'Directions','asl_locator') ?></span></p>
          </div>
          {{if dist_str}}
          <div class="col-xs-6">
