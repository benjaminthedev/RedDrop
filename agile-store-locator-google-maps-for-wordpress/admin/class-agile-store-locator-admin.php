	...
	public function update_category() {
		...
		if($data['action'] == "notsame") {
			...
			// upload 
				...
				$update_params = array('category_name'=> $data['category_name'], 'icon'=> $target_name, 'ordr' => $order_id);
			
				$wpdb->update(ASL_PREFIX."categories", $update_params, array('id' => $data['category_id']));
		...
		//without icon
			...
			$wpdb->update(ASL_PREFIX."categories",array('category_name' => $data['category_name'], 'ordr' => $order_id),array('id' => $data['category_id']));
			$response->msg = __('Updated Successfully.','asl_admin');
			$response->success = true;	
