        ...
        <div class="card p-0 mb-4">
          ...
          <div class="card-body">
            ...
            <div class="alert alert-info" role="alert">
              <?php echo __('Upload SVG File for Categories if you are using Template 2. To sort categories by the Order ID, please use shortcode attribute cat_sort="order", example: [ASL_STORELOCATOR cat_sort="order"]','asl_admin') ?>
            </div>
              ...
              <table id="tbl_categories" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th align="center"><input type="text" class="form-control" data-id="ordr"  placeholder="<?php echo __('Order ID','asl_admin') ?>"  /></th>
                      <th align="center">&nbsp;</th>
                      <th align="center">&nbsp;</th>
                      <th align="center">&nbsp;</th>
                    </tr>
                    <tr>
                      ...
                      <th align="center"><?php echo __('Order ID','asl_admin') ?></th>
    ...
    <div class="smodal-content">
      ...
      <div class="smodal-body">
        <div class="row">
          ...
          <div class="col-md-12 form-group mb-3">
            <label for="update_category_ordr"  class="control-label"><?php echo __('Order','asl_admin') ?></label>
    ...
    <div class="smodal-content">
      ...
      <div class="smodal-body">
        <div class="row">
          ...
          <div class="col-md-12 form-group mb-3">
            <label for="add_category_ordr"  class="control-label"><?php echo __('Order','asl_admin') ?></label>
