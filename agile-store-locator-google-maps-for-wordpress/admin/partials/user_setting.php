	...
	<div class="container">
		<div class="row asl-inner-cont">
      	...
      	<div class="card p-0 mb-4">
					<h3 class="card-title"><?php echo __('Manage Additional Fields','asl_admin') ?></h3>
	          <div class="card-body">
					            				...
					            				<th><?php echo __('Action','asl_admin') ?></th>
												  ...
												  <tbody>
												  	<?php foreach($fields as $field): ?>
															<tr>
		                            <td colspan="1"><div class="form-group"><input value="<?php echo $field['label'] ?>" type="text" class="asl-attr-label form-control validate[required,funcCall[ASLValidateLabel]]"></div></td>
		                            <td colspan="1"><div class="form-group"><input value="<?php echo $field['name'] ?>" type="text" class="asl-attr-name form-control validate[required,funcCall[ASLValidateName]]"></div></td>
		                            <td colspan="1">
          	...
          	<form id="frm-usersetting">
          		<div class="row mt-2">
          			...
          			<div class="col-md-4 form-group mb-4">
							  ...
							  <div class="col-md-4 form-group mb-4">
							    <label><?php echo __('List Load','asl_admin') ?></label>
							    <select  name="data[first_load]" id="asl-first_load" class="custom-select">
							      <option value="1"><?php echo __('Default','asl_admin') ?></option>
							      <option value="2"><?php echo __('No List and Markers at Load','asl_admin') ?></option>
							      <option value="3"><?php echo __('No List and Markers with Full Map at Load','asl_admin') ?></option>
							      <option value="4"><?php echo __('No List at Load','asl_admin') ?></option>
							    </select>
							    <p class="help-p text-muted">(<?php echo __('Stop list loading before search.','asl_admin') ?>)</p>
							  </div>
							  <div class="col-md-4 form-group mb-4">
							    <label><?php echo __('Map/List Order (Mobile Only)','asl_admin') ?></label>
							  ...
							  <div class="col-md-4 form-group mb-4">
							    <label><?php echo __('Store Direction','asl_admin') ?></label>
							    <select  name="data[direction_redirect]" id="asl-direction_redirect" class="custom-select">
							      <option value="0"><?php echo __('Show in Direction Panel','asl_admin') ?></option>
							      <option value="1"><?php echo __('Open in Google Maps (mobile)','asl_admin') ?></option>
							      <option value="2"><?php echo __('Open in Google Maps (mobile & desktop)','asl_admin') ?></option>
							    </select>
							    <p class="help-p text-muted">(<?php echo __('Stop list loading before search.','asl_admin') ?>)</p>
							  </div>
							</div>
							<div class="row">
							  ...
							  <div class="col-md-4 form-group mb-4" style="display: none;">
							  	<div class="custom-control custom-checkbox">
							  ...
							  <div class="col-md-4 form-group mb-4">
							  	<div class="custom-control custom-checkbox">
									...
									<p class="help-p text-muted">(<?php echo __('Category icons will appear, manage markers will not be used.','asl_admin') ?>)</p>
							  </div>
							  <div class="col-md-4 form-group mb-4">
							  	<div class="custom-control custom-checkbox">
          			...
          			<div class="col-md-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select id="asl-template" class="custom-select col-md-12" name="data[template]">
                                ...
                                <option value="3"><?php echo __('Template','asl_admin') ?> 3 (BETA version)</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group mb-3">
                          ...
                          <select id="asl-layout" class="custom-select" name="data[layout]">
                              ...
                              <option value="1"><?php echo __('Accordion (States, Cities, Countries)','asl_admin') ?></option>
                              <option value="2"><?php echo __('Accordion (Categories)','asl_admin') ?></option>
                          </select>
                      </div>
                    </div>
                    <div class="form-group">
                    	<div class="template-box box_layout_3 hide">
										    <div class="form-group mb-3 color_scheme">
										      ...
										      <div class="a-radio-select">
										        ...
										        <span>
										          <input type="radio" id="asl-color_scheme_3-<?php echo $_ind ?>" value="<?php echo $_ind ?>" name="data[color_scheme_3]">
										          <label class="color-box color-<?php echo $_ind ?>" for="asl-color_scheme_3-<?php echo $_ind ?>"></label>
										        </span>
										        <?php endfor; ?>
										      </div>
										    </div>
                    	...
                    	<div class="template-box box_layout_0 hide">
										  ...
										  <div class="template-box box_layout_0 box_layout_3 hide">
										  ...
										  <p class="help-p text-muted"><?php echo __('Colors Missing? Create your own color ','asl_admin') ?><a target="_blank" href="https://agilestorelocator.com/store-locator-color-maker/"><?php echo __('Color Maker','asl_admin') ?></a></p>
                    </div>
                </div>
                <div class="col-md-4 justify-content-md-center text-center">
          		...
          		<div class="row">
          			<div class="col-md-12 form-group mb-3 map_layout">
                        ...
                        <textarea id="asl-map_layout_custom" style="width: 100%" rows="6"  placeholder="<?php echo __('Google Style','asl_admin') ?>"  class="input-medium form-control"><?php echo $custom_map_style ?></textarea>
                    	</div>
								    </div>
							    </div>
							  </div>
      ...
      <div class="col-md-12 asl-faq-sec">
      	<div class="card p-0 mb-4">
					<h3 class="card-title"><?php echo __('FAQ & Help','asl_admin') ?></h3>
          <div class="card-body">
						<div class="alert alert-info" role="alert"><?php echo __('Create a support ticket by emailing us at ','asl_admin') ?> <a target="_blank" href="mailto:support@agilelogix.com">support@agilelogix.com</a>, <?php echo __('we will get back to you as soon as possible, please include ("Store Locator" in the Subject) to avoid the spam list.','asl_admin') ?></div>
						<p class="mb--3"><b>How to add a Store Locator?</b></p>
          	<p>To add the store locator on the page write down the shortcode of the plugin <b>[ASL_STORELOCATOR]</b>, after that click publish to save the page.</p>
          	<p class="mb--3"><b>How to Store Locator Search Widget?</b></p>
          	<p>To add the Search Widget of the Store Locator write down the shortcode, in the redirect attribute provide the absolute URL of the store locator, example: https://mydomain.com/store-locator <b>[ASL_SEARCH category_control="1" redirect="url-of-your-store-locator-page"]</b>, replace the <b>redirect</b> parameter with the URL of your store locator, and save the page.</p>
						<p class="mb--3"><b>How to add the Google API Keys?</b></p>
						<div class="mb--3">
							<p >The video tutorial will show how you can setup the Google API Keys for the store locator plugin.</p>
							<iframe width="560" height="315" src="https://www.youtube.com/embed/CC0WMJcGpFM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
          	<p class="mb--3"><b>FAQ Links</b></p>
						<ul class="asl-faq">
					    ...
					    <li><a target="_blank" href="https://agilestorelocator.com/wiki/use-agile-store-locator-shortcodes/">Store Locator Shortcodes Attributes</a></li>
					    <li><a target="_blank" href="https://agilestorelocator.com/wiki/can-import-stores-using-excel-sheet/">How can I import using CSV Sheet?</a></li>
					  ...
					  <div class="row">
					    ...
					    We will respond as soon as possible to resolve your problem, please include ("Store Locator" in the Subject) to avoid the spam list.</p>
