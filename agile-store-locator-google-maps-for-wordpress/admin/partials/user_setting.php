	...
	<div class="container">
		<div class="row asl-inner-cont">
      	...
      	<div class="card p-0 mb-4">
	          ...
	          <div class="card-body">
	            	...
	            	<div class="row">
	            		<div class="col-md-12">
	            			<p><?php echo __('Additional fields for the store can be created through this section, new fields will appear in the store form and via CSV import.','asl_admin') ?></p>
      ...
      <div class="col-md-12 asl-faq-sec">
          ...
          <div class="card-body">
          	...
          	<p>To add the Search Widget of the Store Locator write down the shortcode <b>[ASL_SEARCH category_control="1" redirect="url-of-your-store-locator-page"]</b>, replace the <b>redirect</b> parameter with the URL of your store locator, and save the page.</p>
