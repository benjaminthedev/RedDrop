          ...
          <div class="card-body">
              <form id="frm-addstore">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group mb-3">
                      <label for="txt_brand"><?php echo __('Brand','asl_admin') ?></label>
                      <select name="ddl_brand"  id="ddl_brand" multiple class="asl-chosen chosen-select-width form-control">                      
                        <?php foreach($brands as $brand): ?>
                          <option  <?php foreach($store_brand as $s_brand ) if($s_brand == $brand->id) echo 'selected="selected" '; ?> value="<?php echo $brand->id ?>"><?php echo $brand->name ?></option>
                        <?php endforeach ?>
                      </select>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                    ...
                    <?php foreach($fields as $field): ?>
                      <div class="col-md-6 form-group mb-3">
                        <label for="custom-f-<?php echo $field['name'] ?>"><?php echo $field['label'] ?></label>
                        <input type="text" value="<?php echo isset($custom_data[$field['name']])? $custom_data[$field['name']]: '' ?>" id="custom-f-<?php echo $field['name'] ?>" name="asl-custom[<?php echo $field['name'] ?>]"  class="form-control">
                      </div>
                    <?php endforeach; ?>
                  </div>
