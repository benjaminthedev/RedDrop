      ...
      <div class="col-md-12">
        <div class="card p-0 mb-4">
          ...
          <div class="card-body">
              ...
              <div class="col-md-12"><p class="alert alert-danger" style="font-size: 14px"><?php echo __('ZipArchive is not found in your PHP, Contact your server admin OR login to your cpanel and enable it. Import/Export will Not work without this library.','asl_admin') ?></p></div>
              <?php endif; ?>
              <?php if(!is_writable(ASL_PLUGIN_PATH.'public/import')): ?>
               <div class="col-md-12"><p class="alert alert-danger" style="font-size: 14px"><?php echo ASL_PLUGIN_PATH.'public/import' ?> <= <?php echo __('Directory is not writable, Excel Import will Fail, Make directory writable.','asl_admin') ?> ?></p></div>
              <?php endif; ?>
            </div>
            <div class="row">
              <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <p class="alert alert-warning"><?php echo __('Current build works with CSV with comma as the delimiter. Please contact us at support@agilelogix.com for support.','asl_admin') ?></p>
    ...
    <div class="smodal-dialog" role="document">
      <div class="smodal-content">
        <div class="smodal-header">
          <h5 class="smodal-title"><?php echo __('Upload CSV File','asl_admin') ?></h5>
