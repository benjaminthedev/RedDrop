...
class AgileStoreLocator {
	...
	public function add_admin_menu() {
		...
		if (current_user_can('delete_posts')) {
			...
			add_Menu_page('Agile Store Locator', __('A Store Locator','asl_admin'), 'delete_posts', 'asl-plugin', array($this->plugin_admin,'admin_plugin_settings'),$svg);
			...
			add_submenu_page( 'asl-plugin', __('Manage Markers','asl_admin'), __('Manage Markers','asl_admin'), 'delete_posts', 'manage-store-markers', array($this->plugin_admin,'admin_store_markers'));
			add_submenu_page( 'asl-plugin', __('Manage Logos','asl_admin'), __('Manage Logos','asl_admin'), 'delete_posts', 'manage-store-logos', array($this->plugin_admin,'admin_store_logos'));
			...
			add_submenu_page( 'asl-plugin', __('Manage Brands','asl_admin'), __('Manage Brands','asl_admin'), 'delete_posts', 'manage-asl-filter', array($this->plugin_admin,'admin_manage_attribute'));
			add_submenu_page( 'asl-plugin', __('Import/Export Stores','asl_admin'), __('Import/Export Stores','asl_admin'), 'delete_posts', 'import-store-list', array($this->plugin_admin,'admin_import_stores'));
			...
			add_submenu_page( 'asl-plugin', __('Customize Map','asl_admin'), __('Customize Map','asl_admin'), 'delete_posts', 'customize-map', array($this->plugin_admin,'admin_customize_map'));
