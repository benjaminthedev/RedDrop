		...
		if ($type == 'simple') {
			...
			$output .= '<div class="share-simple-wrapper '. esc_attr($class) .'">';
				...
				$output .= '<div class="icons">';
					...
					$output .= '<a target="_blank" class="twitter" href="https://twitter.com/intent/tweet?text='. esc_attr(wp_get_document_title()) .'. '. esc_url(get_permalink()) .'"><i class="icon-twitter"></i></a>';
					$output .= '<a target="_blank" class="google" href="https://plus.google.com/share?url='. urlencode(esc_url(get_permalink())) .'"><i class="icon-gplus"></i></a>';
					$output .= '<a target="_blank" class="linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url='. urlencode(esc_url(get_permalink())) .'&title='. esc_attr(wp_get_document_title()) .'"><i class="icon-linkedin"></i></a>';
			...
			$output .= '<div class="share_wrapper '. esc_attr($class) .'">';
				...
				$output .= '<script src="https://ws.sharethis.com/button/buttons.js"></script>';
